...
switch pcmChoice
	...
	case 'NaCl-MgCl' % All data from https://doi.org/10.1016/j.solener.2020.09.038
		Tmelt = 438;   % Increased for the sake of experimentation
        dTMelt = 4; % assumed
        TmeltStart = Tmelt-dTMelt/2;                    TmeltEnd = TmeltStart + dTMelt;
        
        cPCMSolid = 5463;       cPCMLiquid = 5463; 
        enthalpyFusion = 268160; 
        kPCMSolid = 0.5;        kPCMLiquid = 0.5; 
        densityPCMSolid = 1782; densityPCMLiquid = 1782;
end
