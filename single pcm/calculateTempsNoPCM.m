function [tempMatrixStorage,tempMatrixFluid] = calculateTempsNoPCM(intEnergyMatrixStorage,intEnergyMatrixFluid,tempMatrixStorage,tempMatrixFluid,~,~,~,~, ~, ~, ~, ~, ~, fluidTestEnergy,fluidEnergyDerivative)
